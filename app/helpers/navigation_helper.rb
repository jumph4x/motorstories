module NavigationHelper
  ...
  def make_dropdown
    ...
    select_tag :make, options_for_select(collection, current_make.try(:name).try(:to_url))
  end
  ...
  def model_dropdown
    ...
    select_tag :model, options_for_select(collection, current_model.try(:name).try(:to_url)), html_hash
  end
